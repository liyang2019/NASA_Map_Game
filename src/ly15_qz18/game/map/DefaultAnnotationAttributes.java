...
public class DefaultAnnotationAttributes extends AnnotationAttributes implements Serializable {
	...
	private static final Color BACKGROUND_COLOR = new Color(0f, 0f, 0f, .5f);
	private static final Color TEXT_COLOR = Color.WHITE;
	private static final double DISTANCE_MIN_SCALE = 0.5;
	private static final double DISTANCE_MAX_SCALE = 2.0;
	private static final double DISTANCE_MIN_OPACITY = 0.5;
	private static final int LEADER_GAP_WIDTH =  14;
	private static final Point DRAW_OFFSET = new Point(20, 40);
